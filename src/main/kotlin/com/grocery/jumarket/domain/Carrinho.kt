...
data class Carrinho(
        ...
        @OneToOne(mappedBy = "carrinho") var venda: Venda?,
        @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "usuario_id") var usuario: Usuario?,
        @Enumerated(EnumType.STRING) var status: StatusCarrinho = StatusCarrinho.PENDENTE
